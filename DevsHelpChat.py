...
# meta developer: @AuthorChe | Anonymous
...
class AuthorChatMod(loader.Module):
    ...
    strings = {
        ...
        "version": (
            "<b>🪆 {}</b>\n\n"
            "<b>😌 Author great сoder</b>\n"
            "<b>📥 Downloaded from @vadym_yem | anonymous </b>\n"
            "<b>{}</b>"
        ),
        ...
        "banninja_report": (
            ...
            "<i>Deleted {} bot(-s)</i>\n\n"
            "🏹 <i>«BanNinja can handle any size of attack»</i> © <code>DevsHelpChat</code>"
        ),
        "confirm_rmfed": (
    ...
    strings_ru = {
        ...
        "_cmd_doc_setaclog": "Установить чат логирования",
        ...
        "fed": '💼 <b>Федерация "{}":</b>\n🔰 <b>Чаты:</b>\n<b>{}</b>\n🔰 <b>Каналы:</b>\n<b>{}</b>\n🔰 <b>Админы:</b>\n<b>{}</b>\n🔰 <b>Предупреждения: {}</b>\n',
        "version": "<b>🪆 {}</b>\n\n<b>😌 Автор лучший</b>\n<b>📥 Скачано из @vadym_yem | Анонимус</b>\n<b>{}</b>",
    ...
    async def client_ready(
        ...
        self.__doc__ = (
            "Advanced chat admin toolkit\nNow became free...\n📣 Downloaded from: @vadym_yem | anonymous\n\n"
            + f"📦Version: {version}\n"
